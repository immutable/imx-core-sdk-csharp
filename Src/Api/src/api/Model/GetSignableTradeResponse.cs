...
namespace api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetSignableTradeResponse")]
    public partial class GetSignableTradeResponse : IEquatable<GetSignableTradeResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSignableTradeResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetSignableTradeResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSignableTradeResponse" /> class.
        /// </summary>
        ...
        /// <param name="payloadHash">Payload Hash (required).</param>
        /// <param name="signableMessage">Message to sign with L1 wallet to confirm trade request (required).</param>
        ...
        public GetSignableTradeResponse(string amountBuy = default(string), string amountSell = default(string), string assetIdBuy = default(string), string assetIdSell = default(string), int expirationTimestamp = default(int), FeeInfo feeInfo = default(FeeInfo), int nonce = default(int), string payloadHash = default(string), string signableMessage = default(string), string starkKey = default(string), int vaultIdBuy = default(int), int vaultIdSell = default(int))
        {
            // to ensure "amountBuy" is required (not null)
            if (amountBuy == null)
            {
                throw new ArgumentNullException("amountBuy is a required property for GetSignableTradeResponse and cannot be null");
            }
            this.AmountBuy = amountBuy;
            // to ensure "amountSell" is required (not null)
            if (amountSell == null)
            {
                throw new ArgumentNullException("amountSell is a required property for GetSignableTradeResponse and cannot be null");
            }
            this.AmountSell = amountSell;
            // to ensure "assetIdBuy" is required (not null)
            if (assetIdBuy == null)
            {
                throw new ArgumentNullException("assetIdBuy is a required property for GetSignableTradeResponse and cannot be null");
            }
            this.AssetIdBuy = assetIdBuy;
            // to ensure "assetIdSell" is required (not null)
            if (assetIdSell == null)
            {
                throw new ArgumentNullException("assetIdSell is a required property for GetSignableTradeResponse and cannot be null");
            }
            ...
            if (payloadHash == null)
            {
                throw new ArgumentNullException("payloadHash is a required property for GetSignableTradeResponse and cannot be null");
            }
            this.PayloadHash = payloadHash;
            // to ensure "signableMessage" is required (not null)
            if (signableMessage == null)
            {
                throw new ArgumentNullException("signableMessage is a required property for GetSignableTradeResponse and cannot be null");
            }
            this.SignableMessage = signableMessage;
            // to ensure "starkKey" is required (not null)
            if (starkKey == null)
            {
                throw new ArgumentNullException("starkKey is a required property for GetSignableTradeResponse and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Message to sign with L1 wallet to confirm trade request</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSignableTradeResponse {\n");
        ...
        {
            return this.Equals(input as GetSignableTradeResponse);
        }

        /// <summary>
        /// Returns true if GetSignableTradeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetSignableTradeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSignableTradeResponse input)
        {
            if (input == null)
            {
                return false;
