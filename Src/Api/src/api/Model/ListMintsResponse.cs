...
namespace api.Model
{
    ...
    /// ListMintsResponse
    /// </summary>
    [DataContract(Name = "ListMintsResponse")]
    public partial class ListMintsResponse : IEquatable<ListMintsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListMintsResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListMintsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListMintsResponse" /> class.
        /// </summary>
        ...
        public ListMintsResponse(string cursor = default(string), int remaining = default(int), List<Mint> result = default(List<Mint>))
        {
            // to ensure "cursor" is required (not null)
            if (cursor == null)
            {
                throw new ArgumentNullException("cursor is a required property for ListMintsResponse and cannot be null");
            }
            this.Cursor = cursor;
            ...
            if (result == null)
            {
                throw new ArgumentNullException("result is a required property for ListMintsResponse and cannot be null");
            }
            this.Result = result;
        }
        ...
        public List<Mint> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListMintsResponse {\n");
        ...
        {
            return this.Equals(input as ListMintsResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ListMintsResponse input)
        {
            if (input == null)
            {
                return false;
