...
namespace api.Api
{
    ...
    public partial class MetadataRefreshesApi : IMetadataRefreshesApi
    {
        ...
        /// <returns></returns>
        public MetadataRefreshesApi(api.Client.Configuration configuration)
        {
        ...
        public MetadataRefreshesApi(api.Client.ISynchronousClient client, api.Client.IAsynchronousClient asyncClient, api.Client.IReadableConfiguration configuration)
        {
        ...
        {
            api.Client.ApiResponse<GetMetadataRefreshes> localVarResponse = GetAListOfMetadataRefreshesWithHttpInfo(xImxEthSignature, xImxEthTimestamp, xImxEthAddress, pageSize, cursor, collectionAddress);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetMetadataRefreshes</returns>
        public api.Client.ApiResponse<GetMetadataRefreshes> GetAListOfMetadataRefreshesWithHttpInfo(string xImxEthSignature, string xImxEthTimestamp, string xImxEthAddress, int? pageSize = default(int?), string cursor = default(string), string collectionAddress = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'xImxEthSignature' is set
            if (xImxEthSignature == null)
            {
                throw new api.Client.ApiException(400, "Missing required parameter 'xImxEthSignature' when calling MetadataRefreshesApi->GetAListOfMetadataRefreshes");
            }

            // verify the required parameter 'xImxEthTimestamp' is set
            if (xImxEthTimestamp == null)
            {
                throw new api.Client.ApiException(400, "Missing required parameter 'xImxEthTimestamp' when calling MetadataRefreshesApi->GetAListOfMetadataRefreshes");
            }

            // verify the required parameter 'xImxEthAddress' is set
            if (xImxEthAddress == null)
            {
                throw new api.Client.ApiException(400, "Missing required parameter 'xImxEthAddress' when calling MetadataRefreshesApi->GetAListOfMetadataRefreshes");
            }
            ...
            {
                localVarRequestOptions.QueryParameters.Add(api.Client.ClientUtils.ParameterToMultiMap("", "collection_address", collectionAddress));
            }
        ...
        {
            api.Client.ApiResponse<GetMetadataRefreshes> localVarResponse = await GetAListOfMetadataRefreshesWithHttpInfoAsync(xImxEthSignature, xImxEthTimestamp, xImxEthAddress, pageSize, cursor, collectionAddress, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetMetadataRefreshes)</returns>
        public async System.Threading.Tasks.Task<api.Client.ApiResponse<GetMetadataRefreshes>> GetAListOfMetadataRefreshesWithHttpInfoAsync(string xImxEthSignature, string xImxEthTimestamp, string xImxEthAddress, int? pageSize = default(int?), string cursor = default(string), string collectionAddress = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'xImxEthSignature' is set
            if (xImxEthSignature == null)
            {
        ...
        {
            api.Client.ApiResponse<GetMetadataRefreshErrorsResponse> localVarResponse = GetMetadataRefreshErrorsWithHttpInfo(refreshId, xImxEthSignature, xImxEthTimestamp, xImxEthAddress, pageSize, cursor);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetMetadataRefreshErrorsResponse</returns>
        public api.Client.ApiResponse<GetMetadataRefreshErrorsResponse> GetMetadataRefreshErrorsWithHttpInfo(string refreshId, string xImxEthSignature, string xImxEthTimestamp, string xImxEthAddress, int? pageSize = default(int?), string cursor = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'refreshId' is set
            if (refreshId == null)
            {
                throw new api.Client.ApiException(400, "Missing required parameter 'refreshId' when calling MetadataRefreshesApi->GetMetadataRefreshErrors");
            }

            // verify the required parameter 'xImxEthSignature' is set
            if (xImxEthSignature == null)
            {
                throw new api.Client.ApiException(400, "Missing required parameter 'xImxEthSignature' when calling MetadataRefreshesApi->GetMetadataRefreshErrors");
            }

            // verify the required parameter 'xImxEthTimestamp' is set
            if (xImxEthTimestamp == null)
            {
                throw new api.Client.ApiException(400, "Missing required parameter 'xImxEthTimestamp' when calling MetadataRefreshesApi->GetMetadataRefreshErrors");
            }

            // verify the required parameter 'xImxEthAddress' is set
            if (xImxEthAddress == null)
            {
                throw new api.Client.ApiException(400, "Missing required parameter 'xImxEthAddress' when calling MetadataRefreshesApi->GetMetadataRefreshErrors");
            }
        ...
        {
            api.Client.ApiResponse<GetMetadataRefreshErrorsResponse> localVarResponse = await GetMetadataRefreshErrorsWithHttpInfoAsync(refreshId, xImxEthSignature, xImxEthTimestamp, xImxEthAddress, pageSize, cursor, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetMetadataRefreshErrorsResponse)</returns>
        public async System.Threading.Tasks.Task<api.Client.ApiResponse<GetMetadataRefreshErrorsResponse>> GetMetadataRefreshErrorsWithHttpInfoAsync(string refreshId, string xImxEthSignature, string xImxEthTimestamp, string xImxEthAddress, int? pageSize = default(int?), string cursor = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'refreshId' is set
            if (refreshId == null)
            {
        ...
        {
            api.Client.ApiResponse<GetMetadataRefreshResponse> localVarResponse = GetMetadataRefreshResultsWithHttpInfo(refreshId, xImxEthSignature, xImxEthTimestamp, xImxEthAddress);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetMetadataRefreshResponse</returns>
        public api.Client.ApiResponse<GetMetadataRefreshResponse> GetMetadataRefreshResultsWithHttpInfo(string refreshId, string xImxEthSignature, string xImxEthTimestamp, string xImxEthAddress, int operationIndex = 0)
        {
            // verify the required parameter 'refreshId' is set
            if (refreshId == null)
            {
                throw new api.Client.ApiException(400, "Missing required parameter 'refreshId' when calling MetadataRefreshesApi->GetMetadataRefreshResults");
            }

            // verify the required parameter 'xImxEthSignature' is set
            if (xImxEthSignature == null)
            {
                throw new api.Client.ApiException(400, "Missing required parameter 'xImxEthSignature' when calling MetadataRefreshesApi->GetMetadataRefreshResults");
            }

            // verify the required parameter 'xImxEthTimestamp' is set
            if (xImxEthTimestamp == null)
            {
                throw new api.Client.ApiException(400, "Missing required parameter 'xImxEthTimestamp' when calling MetadataRefreshesApi->GetMetadataRefreshResults");
            }

            // verify the required parameter 'xImxEthAddress' is set
            if (xImxEthAddress == null)
            {
                throw new api.Client.ApiException(400, "Missing required parameter 'xImxEthAddress' when calling MetadataRefreshesApi->GetMetadataRefreshResults");
            }
        ...
        {
            api.Client.ApiResponse<GetMetadataRefreshResponse> localVarResponse = await GetMetadataRefreshResultsWithHttpInfoAsync(refreshId, xImxEthSignature, xImxEthTimestamp, xImxEthAddress, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetMetadataRefreshResponse)</returns>
        public async System.Threading.Tasks.Task<api.Client.ApiResponse<GetMetadataRefreshResponse>> GetMetadataRefreshResultsWithHttpInfoAsync(string refreshId, string xImxEthSignature, string xImxEthTimestamp, string xImxEthAddress, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'refreshId' is set
            if (refreshId == null)
            {
        ...
        {
            api.Client.ApiResponse<CreateMetadataRefreshResponse> localVarResponse = RequestAMetadataRefreshWithHttpInfo(xImxEthSignature, xImxEthTimestamp, xImxEthAddress, createMetadataRefreshRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CreateMetadataRefreshResponse</returns>
        public api.Client.ApiResponse<CreateMetadataRefreshResponse> RequestAMetadataRefreshWithHttpInfo(string xImxEthSignature, string xImxEthTimestamp, string xImxEthAddress, CreateMetadataRefreshRequest createMetadataRefreshRequest, int operationIndex = 0)
        {
            // verify the required parameter 'xImxEthSignature' is set
            if (xImxEthSignature == null)
            {
                throw new api.Client.ApiException(400, "Missing required parameter 'xImxEthSignature' when calling MetadataRefreshesApi->RequestAMetadataRefresh");
            }

            // verify the required parameter 'xImxEthTimestamp' is set
            if (xImxEthTimestamp == null)
            {
                throw new api.Client.ApiException(400, "Missing required parameter 'xImxEthTimestamp' when calling MetadataRefreshesApi->RequestAMetadataRefresh");
            }

            // verify the required parameter 'xImxEthAddress' is set
            if (xImxEthAddress == null)
            {
                throw new api.Client.ApiException(400, "Missing required parameter 'xImxEthAddress' when calling MetadataRefreshesApi->RequestAMetadataRefresh");
            }

            // verify the required parameter 'createMetadataRefreshRequest' is set
            if (createMetadataRefreshRequest == null)
            {
                throw new api.Client.ApiException(400, "Missing required parameter 'createMetadataRefreshRequest' when calling MetadataRefreshesApi->RequestAMetadataRefresh");
            }
        ...
        {
            api.Client.ApiResponse<CreateMetadataRefreshResponse> localVarResponse = await RequestAMetadataRefreshWithHttpInfoAsync(xImxEthSignature, xImxEthTimestamp, xImxEthAddress, createMetadataRefreshRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CreateMetadataRefreshResponse)</returns>
        public async System.Threading.Tasks.Task<api.Client.ApiResponse<CreateMetadataRefreshResponse>> RequestAMetadataRefreshWithHttpInfoAsync(string xImxEthSignature, string xImxEthTimestamp, string xImxEthAddress, CreateMetadataRefreshRequest createMetadataRefreshRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'xImxEthSignature' is set
            if (xImxEthSignature == null)
            {
