...
namespace Imx.Sdk.Gen.Model
{
    ...
    public partial class ListAssetsResponse : IEquatable<ListAssetsResponse>, IValidatableObject
    {
        ...
        public ListAssetsResponse(string cursor = default(string), int remaining = default(int), List<AssetWithOrders> result = default(List<AssetWithOrders>))
        {
            // to ensure "cursor" is required (not null)
            if (cursor == null)
            {
                throw new ArgumentNullException("cursor is a required property for ListAssetsResponse and cannot be null");
            }
            this.Cursor = cursor;
            ...
            if (result == null)
            {
                throw new ArgumentNullException("result is a required property for ListAssetsResponse and cannot be null");
            }
            this.Result = result;
        }
        ...
        public List<AssetWithOrders> Result { get; set; }
