...
namespace Imx.Sdk.Gen.Model
{
    ...
    /// GetProjectsResponse
    /// </summary>
    [DataContract(Name = "GetProjectsResponse")]
    public partial class GetProjectsResponse : IEquatable<GetProjectsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectsResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetProjectsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProjectsResponse" /> class.
        /// </summary>
        ...
        /// <param name="result">Projects matching query parameters (required).</param>
        public GetProjectsResponse(string cursor = default(string), int remaining = default(int), List<Project> result = default(List<Project>))
        {
            // to ensure "cursor" is required (not null)
            if (cursor == null)
            {
                throw new ArgumentNullException("cursor is a required property for GetProjectsResponse and cannot be null");
            }
            this.Cursor = cursor;
            ...
            if (result == null)
            {
                throw new ArgumentNullException("result is a required property for GetProjectsResponse and cannot be null");
            }
            this.Result = result;
        }
        ...
        /// </summary>
        /// <value>Projects matching query parameters</value>
        ...
        {
            return this.Equals(input as GetProjectsResponse);
        }

        /// <summary>
        /// Returns true if GetProjectsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetProjectsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetProjectsResponse input)
        {
            if (input == null)
            {
                return false;
