...
namespace Imx.Sdk.Gen.Model
{
    ...
    public partial class ListBalancesResponse : IEquatable<ListBalancesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListBalancesResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListBalancesResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListBalancesResponse" /> class.
        /// </summary>
        ...
        public ListBalancesResponse(string cursor = default(string), int remaining = default(int), List<Balance> result = default(List<Balance>))
        {
            // to ensure "cursor" is required (not null)
            if (cursor == null)
            {
                throw new ArgumentNullException("cursor is a required property for ListBalancesResponse and cannot be null");
            }
            this.Cursor = cursor;
            ...
            if (result == null)
            {
                throw new ArgumentNullException("result is a required property for ListBalancesResponse and cannot be null");
            }
            this.Result = result;
        }
        ...
        {
            return this.Equals(input as ListBalancesResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ListBalancesResponse input)
        {
            if (input == null)
            {
                return false;
