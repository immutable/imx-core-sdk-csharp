...
namespace Imx.Sdk.Gen.Model
{
    ...
    public partial class Token : IEquatable<Token>, IValidatableObject
    {
        ...
        public Token(TokenData data = default(TokenData), string type = default(string))
        {
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for Token and cannot be null");
            }
            this.Data = data;
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for Token and cannot be null");
            }
            this.Type = type;
        }
