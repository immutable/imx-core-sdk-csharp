...
namespace Imx.Sdk.Gen.Model
{
    ...
    /// FeeEntry
    /// </summary>
    [DataContract(Name = "FeeEntry")]
    public partial class FeeEntry : IEquatable<FeeEntry>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeeEntry" /> class.
        /// </summary>
        /// <param name="address">address.</param>
        /// <param name="feePercentage">feePercentage.</param>
        public FeeEntry(string address = default(string), decimal feePercentage = default(decimal))
        {
        ...
        /// </summary>
        [DataMember(Name = "fee_percentage", EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as FeeEntry);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(FeeEntry input)
        {
            if (input == null)
            {
                return false;
