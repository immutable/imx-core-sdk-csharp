...
namespace Imx.Sdk.Gen.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListDepositsResponse")]
    public partial class ListDepositsResponse : IEquatable<ListDepositsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListDepositsResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListDepositsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListDepositsResponse" /> class.
        /// </summary>
        ...
        public ListDepositsResponse(string cursor = default(string), int remaining = default(int), List<Deposit> result = default(List<Deposit>))
        {
            // to ensure "cursor" is required (not null)
            if (cursor == null)
            {
                throw new ArgumentNullException("cursor is a required property for ListDepositsResponse and cannot be null");
            }
            this.Cursor = cursor;
            ...
            if (result == null)
            {
                throw new ArgumentNullException("result is a required property for ListDepositsResponse and cannot be null");
            }
            this.Result = result;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListDepositsResponse {\n");
        ...
        {
            return this.Equals(input as ListDepositsResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ListDepositsResponse input)
        {
            if (input == null)
            {
                return false;
