...
namespace Imx.Sdk.Gen.Model
{
    ...
    public partial class Transfer : IEquatable<Transfer>, IValidatableObject
    {
        ...
        public Transfer(string receiver = default(string), string status = default(string), string timestamp = default(string), Token token = default(Token), int transactionId = default(int), string user = default(string))
        {
            // to ensure "receiver" is required (not null)
            if (receiver == null)
            {
                throw new ArgumentNullException("receiver is a required property for Transfer and cannot be null");
            }
            this.Receiver = receiver;
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for Transfer and cannot be null");
            }
            this.Status = status;
            // to ensure "timestamp" is required (not null)
            if (timestamp == null)
            {
                throw new ArgumentNullException("timestamp is a required property for Transfer and cannot be null");
            }
            this.Timestamp = timestamp;
            // to ensure "token" is required (not null)
            if (token == null)
            {
                throw new ArgumentNullException("token is a required property for Transfer and cannot be null");
            }
            this.Token = token;
