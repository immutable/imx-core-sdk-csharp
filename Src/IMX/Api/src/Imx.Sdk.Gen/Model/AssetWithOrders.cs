...
namespace Imx.Sdk.Gen.Model
{
    ...
    /// AssetWithOrders
    /// </summary>
    [DataContract(Name = "AssetWithOrders")]
    public partial class AssetWithOrders : IEquatable<AssetWithOrders>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetWithOrders" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AssetWithOrders() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetWithOrders" /> class.
        /// </summary>
        ...
        public AssetWithOrders(CollectionDetails collection = default(CollectionDetails), string createdAt = default(string), string description = default(string), List<Fee> fees = default(List<Fee>), string id = default(string), string imageUrl = default(string), Object metadata = default(Object), string name = default(string), OrderDetails orders = default(OrderDetails), string status = default(string), string tokenAddress = default(string), string tokenId = default(string), string updatedAt = default(string), string uri = default(string), string user = default(string))
        {
            // to ensure "collection" is required (not null)
            if (collection == null)
            {
                throw new ArgumentNullException("collection is a required property for AssetWithOrders and cannot be null");
            }
            this.Collection = collection;
            // to ensure "createdAt" is required (not null)
            if (createdAt == null)
            {
                throw new ArgumentNullException("createdAt is a required property for AssetWithOrders and cannot be null");
            }
            this.CreatedAt = createdAt;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for AssetWithOrders and cannot be null");
            }
            this.Description = description;
            // to ensure "imageUrl" is required (not null)
            if (imageUrl == null)
            {
                throw new ArgumentNullException("imageUrl is a required property for AssetWithOrders and cannot be null");
            }
            this.ImageUrl = imageUrl;
            // to ensure "metadata" is required (not null)
            if (metadata == null)
            {
                throw new ArgumentNullException("metadata is a required property for AssetWithOrders and cannot be null");
            }
            this.Metadata = metadata;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AssetWithOrders and cannot be null");
            }
            this.Name = name;
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for AssetWithOrders and cannot be null");
            }
            this.Status = status;
            // to ensure "tokenAddress" is required (not null)
            if (tokenAddress == null)
            {
                throw new ArgumentNullException("tokenAddress is a required property for AssetWithOrders and cannot be null");
            }
            this.TokenAddress = tokenAddress;
            // to ensure "tokenId" is required (not null)
            if (tokenId == null)
            {
                throw new ArgumentNullException("tokenId is a required property for AssetWithOrders and cannot be null");
            }
            this.TokenId = tokenId;
            // to ensure "updatedAt" is required (not null)
            if (updatedAt == null)
            {
                throw new ArgumentNullException("updatedAt is a required property for AssetWithOrders and cannot be null");
            }
            this.UpdatedAt = updatedAt;
            // to ensure "uri" is required (not null)
            if (uri == null)
            {
                throw new ArgumentNullException("uri is a required property for AssetWithOrders and cannot be null");
            }
            this.Uri = uri;
            // to ensure "user" is required (not null)
            if (user == null)
            {
                throw new ArgumentNullException("user is a required property for AssetWithOrders and cannot be null");
            }
            this.User = user;
            this.Fees = fees;
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssetWithOrders {\n");
        ...
        {
            return this.Equals(input as AssetWithOrders);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(AssetWithOrders input)
        {
            if (input == null)
            {
                return false;
