...
namespace Imx.Sdk.Gen.Api
{
    ...
    public partial class AssetsApi : IAssetsApi
    {
        ...
        /// <returns></returns>
        public AssetsApi(Imx.Sdk.Gen.Client.Configuration configuration)
        {
        ...
        public AssetsApi(Imx.Sdk.Gen.Client.ISynchronousClient client, Imx.Sdk.Gen.Client.IAsynchronousClient asyncClient, Imx.Sdk.Gen.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<Asset> localVarResponse = GetAssetWithHttpInfo(tokenAddress, tokenId, includeFees);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Asset</returns>
        public Imx.Sdk.Gen.Client.ApiResponse<Asset> GetAssetWithHttpInfo(string tokenAddress, string tokenId, bool? includeFees = default(bool?), int operationIndex = 0)
        {
            // verify the required parameter 'tokenAddress' is set
            if (tokenAddress == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'tokenAddress' when calling AssetsApi->GetAsset");
            }

            // verify the required parameter 'tokenId' is set
            if (tokenId == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'tokenId' when calling AssetsApi->GetAsset");
            }
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<Asset> localVarResponse = await GetAssetWithHttpInfoAsync(tokenAddress, tokenId, includeFees, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Asset)</returns>
        public async System.Threading.Tasks.Task<Imx.Sdk.Gen.Client.ApiResponse<Asset>> GetAssetWithHttpInfoAsync(string tokenAddress, string tokenId, bool? includeFees = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'tokenAddress' is set
            if (tokenAddress == null)
            {
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<ListAssetsResponse> localVarResponse = ListAssetsWithHttpInfo(pageSize, cursor, orderBy, direction, user, status, name, metadata, sellOrders, buyOrders, includeFees, collection, updatedMinTimestamp, updatedMaxTimestamp, auxiliaryFeePercentages, auxiliaryFeeRecipients);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ListAssetsResponse</returns>
        public Imx.Sdk.Gen.Client.ApiResponse<ListAssetsResponse> ListAssetsWithHttpInfo(int? pageSize = default(int?), string cursor = default(string), string orderBy = default(string), string direction = default(string), string user = default(string), string status = default(string), string name = default(string), string metadata = default(string), bool? sellOrders = default(bool?), bool? buyOrders = default(bool?), bool? includeFees = default(bool?), string collection = default(string), string updatedMinTimestamp = default(string), string updatedMaxTimestamp = default(string), string auxiliaryFeePercentages = default(string), string auxiliaryFeeRecipients = default(string), int operationIndex = 0)
        {
            Imx.Sdk.Gen.Client.RequestOptions localVarRequestOptions = new Imx.Sdk.Gen.Client.RequestOptions();
            ...
            if (name != null)
            {
                localVarRequestOptions.QueryParameters.Add(Imx.Sdk.Gen.Client.ClientUtils.ParameterToMultiMap("", "name", name));
            }
            if (metadata != null)
            {
            ...
            if (sellOrders != null)
            {
                localVarRequestOptions.QueryParameters.Add(Imx.Sdk.Gen.Client.ClientUtils.ParameterToMultiMap("", "sell_orders", sellOrders));
            }
            if (buyOrders != null)
            {
                localVarRequestOptions.QueryParameters.Add(Imx.Sdk.Gen.Client.ClientUtils.ParameterToMultiMap("", "buy_orders", buyOrders));
            }
            if (includeFees != null)
            {
                localVarRequestOptions.QueryParameters.Add(Imx.Sdk.Gen.Client.ClientUtils.ParameterToMultiMap("", "include_fees", includeFees));
            ...
            if (collection != null)
            {
                localVarRequestOptions.QueryParameters.Add(Imx.Sdk.Gen.Client.ClientUtils.ParameterToMultiMap("", "collection", collection));
            }
