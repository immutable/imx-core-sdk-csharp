...
namespace Imx.Sdk.Gen.Api
{
    ...
    public partial class BalancesApi : IBalancesApi
    {
        ...
        /// <returns></returns>
        public BalancesApi(Imx.Sdk.Gen.Client.Configuration configuration)
        {
        ...
        public BalancesApi(Imx.Sdk.Gen.Client.ISynchronousClient client, Imx.Sdk.Gen.Client.IAsynchronousClient asyncClient, Imx.Sdk.Gen.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<Balance> localVarResponse = GetBalanceWithHttpInfo(owner, address);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Balance</returns>
        public Imx.Sdk.Gen.Client.ApiResponse<Balance> GetBalanceWithHttpInfo(string owner, string address, int operationIndex = 0)
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'owner' when calling BalancesApi->GetBalance");
            }

            // verify the required parameter 'address' is set
            if (address == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'address' when calling BalancesApi->GetBalance");
            }
            ...
            localVarRequestOptions.PathParameters.Add("owner", Imx.Sdk.Gen.Client.ClientUtils.ParameterToString(owner)); // path parameter
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<Balance> localVarResponse = await GetBalanceWithHttpInfoAsync(owner, address, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Balance)</returns>
        public async System.Threading.Tasks.Task<Imx.Sdk.Gen.Client.ApiResponse<Balance>> GetBalanceWithHttpInfoAsync(string owner, string address, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
            {
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<ListBalancesResponse> localVarResponse = ListBalancesWithHttpInfo(owner, pageSize, cursor, orderBy, direction);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ListBalancesResponse</returns>
        public Imx.Sdk.Gen.Client.ApiResponse<ListBalancesResponse> ListBalancesWithHttpInfo(string owner, int? pageSize = default(int?), string cursor = default(string), string orderBy = default(string), string direction = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'owner' when calling BalancesApi->ListBalances");
            }
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<ListBalancesResponse> localVarResponse = await ListBalancesWithHttpInfoAsync(owner, pageSize, cursor, orderBy, direction, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ListBalancesResponse)</returns>
        public async System.Threading.Tasks.Task<Imx.Sdk.Gen.Client.ApiResponse<ListBalancesResponse>> ListBalancesWithHttpInfoAsync(string owner, int? pageSize = default(int?), string cursor = default(string), string orderBy = default(string), string direction = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
            {
