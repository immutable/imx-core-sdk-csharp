...
namespace Imx.Sdk.Gen.Api
{
    ...
    public partial class UsersApi : IUsersApi
    {
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<GetSignableRegistrationResponse> localVarResponse = GetSignableRegistrationWithHttpInfo(getSignableRegistrationRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetSignableRegistrationResponse</returns>
        public Imx.Sdk.Gen.Client.ApiResponse<GetSignableRegistrationResponse> GetSignableRegistrationWithHttpInfo(GetSignableRegistrationRequest getSignableRegistrationRequest, int operationIndex = 0)
        {
            // verify the required parameter 'getSignableRegistrationRequest' is set
            if (getSignableRegistrationRequest == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'getSignableRegistrationRequest' when calling UsersApi->GetSignableRegistration");
            }
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<GetSignableRegistrationResponse> localVarResponse = await GetSignableRegistrationWithHttpInfoAsync(getSignableRegistrationRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<GetSignableRegistrationOffchainResponse> localVarResponse = GetSignableRegistrationOffchainWithHttpInfo(getSignableRegistrationRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetSignableRegistrationOffchainResponse</returns>
        public Imx.Sdk.Gen.Client.ApiResponse<GetSignableRegistrationOffchainResponse> GetSignableRegistrationOffchainWithHttpInfo(GetSignableRegistrationRequest getSignableRegistrationRequest, int operationIndex = 0)
        {
            // verify the required parameter 'getSignableRegistrationRequest' is set
            if (getSignableRegistrationRequest == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'getSignableRegistrationRequest' when calling UsersApi->GetSignableRegistrationOffchain");
            }
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<GetSignableRegistrationOffchainResponse> localVarResponse = await GetSignableRegistrationOffchainWithHttpInfoAsync(getSignableRegistrationRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetSignableRegistrationOffchainResponse)</returns>
        public async System.Threading.Tasks.Task<Imx.Sdk.Gen.Client.ApiResponse<GetSignableRegistrationOffchainResponse>> GetSignableRegistrationOffchainWithHttpInfoAsync(GetSignableRegistrationRequest getSignableRegistrationRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'getSignableRegistrationRequest' is set
            if (getSignableRegistrationRequest == null)
            {
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<RegisterUserResponse> localVarResponse = RegisterUserWithHttpInfo(registerUserRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of RegisterUserResponse</returns>
        public Imx.Sdk.Gen.Client.ApiResponse<RegisterUserResponse> RegisterUserWithHttpInfo(RegisterUserRequest registerUserRequest, int operationIndex = 0)
        {
            // verify the required parameter 'registerUserRequest' is set
            if (registerUserRequest == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'registerUserRequest' when calling UsersApi->RegisterUser");
            }
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<RegisterUserResponse> localVarResponse = await RegisterUserWithHttpInfoAsync(registerUserRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (RegisterUserResponse)</returns>
        public async System.Threading.Tasks.Task<Imx.Sdk.Gen.Client.ApiResponse<RegisterUserResponse>> RegisterUserWithHttpInfoAsync(RegisterUserRequest registerUserRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'registerUserRequest' is set
            if (registerUserRequest == null)
            {
