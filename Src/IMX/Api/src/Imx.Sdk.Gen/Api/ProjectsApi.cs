...
namespace Imx.Sdk.Gen.Api
{
    ...
    public partial class ProjectsApi : IProjectsApi
    {
        ...
        /// <returns></returns>
        public ProjectsApi(Imx.Sdk.Gen.Client.Configuration configuration)
        {
        ...
        public ProjectsApi(Imx.Sdk.Gen.Client.ISynchronousClient client, Imx.Sdk.Gen.Client.IAsynchronousClient asyncClient, Imx.Sdk.Gen.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<CreateProjectResponse> localVarResponse = CreateProjectWithHttpInfo(iMXSignature, iMXTimestamp, createProjectRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CreateProjectResponse</returns>
        public Imx.Sdk.Gen.Client.ApiResponse<CreateProjectResponse> CreateProjectWithHttpInfo(string iMXSignature, string iMXTimestamp, CreateProjectRequest createProjectRequest, int operationIndex = 0)
        {
            // verify the required parameter 'iMXSignature' is set
            if (iMXSignature == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'iMXSignature' when calling ProjectsApi->CreateProject");
            }

            // verify the required parameter 'iMXTimestamp' is set
            if (iMXTimestamp == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'iMXTimestamp' when calling ProjectsApi->CreateProject");
            }

            // verify the required parameter 'createProjectRequest' is set
            if (createProjectRequest == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'createProjectRequest' when calling ProjectsApi->CreateProject");
            }
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<CreateProjectResponse> localVarResponse = await CreateProjectWithHttpInfoAsync(iMXSignature, iMXTimestamp, createProjectRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<Project> localVarResponse = GetProjectWithHttpInfo(id, iMXSignature, iMXTimestamp);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Project</returns>
        public Imx.Sdk.Gen.Client.ApiResponse<Project> GetProjectWithHttpInfo(string id, string iMXSignature, string iMXTimestamp, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'id' when calling ProjectsApi->GetProject");
            }

            // verify the required parameter 'iMXSignature' is set
            if (iMXSignature == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'iMXSignature' when calling ProjectsApi->GetProject");
            }

            // verify the required parameter 'iMXTimestamp' is set
            if (iMXTimestamp == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'iMXTimestamp' when calling ProjectsApi->GetProject");
            }
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<Project> localVarResponse = await GetProjectWithHttpInfoAsync(id, iMXSignature, iMXTimestamp, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (Project)</returns>
        public async System.Threading.Tasks.Task<Imx.Sdk.Gen.Client.ApiResponse<Project>> GetProjectWithHttpInfoAsync(string id, string iMXSignature, string iMXTimestamp, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<GetProjectsResponse> localVarResponse = GetProjectsWithHttpInfo(iMXSignature, iMXTimestamp, pageSize, cursor, orderBy, direction);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetProjectsResponse</returns>
        public Imx.Sdk.Gen.Client.ApiResponse<GetProjectsResponse> GetProjectsWithHttpInfo(string iMXSignature, string iMXTimestamp, int? pageSize = default(int?), string cursor = default(string), string orderBy = default(string), string direction = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'iMXSignature' is set
            if (iMXSignature == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'iMXSignature' when calling ProjectsApi->GetProjects");
            }

            // verify the required parameter 'iMXTimestamp' is set
            if (iMXTimestamp == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'iMXTimestamp' when calling ProjectsApi->GetProjects");
            }
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<GetProjectsResponse> localVarResponse = await GetProjectsWithHttpInfoAsync(iMXSignature, iMXTimestamp, pageSize, cursor, orderBy, direction, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetProjectsResponse)</returns>
        public async System.Threading.Tasks.Task<Imx.Sdk.Gen.Client.ApiResponse<GetProjectsResponse>> GetProjectsWithHttpInfoAsync(string iMXSignature, string iMXTimestamp, int? pageSize = default(int?), string cursor = default(string), string orderBy = default(string), string direction = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'iMXSignature' is set
            if (iMXSignature == null)
            {
