...
namespace Imx.Sdk.Gen.Api
{
    ...
    public partial class TokensApi : ITokensApi
    {
        ...
        /// <returns></returns>
        public TokensApi(Imx.Sdk.Gen.Client.Configuration configuration)
        {
        ...
        public TokensApi(Imx.Sdk.Gen.Client.ISynchronousClient client, Imx.Sdk.Gen.Client.IAsynchronousClient asyncClient, Imx.Sdk.Gen.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<TokenDetails> localVarResponse = GetTokenWithHttpInfo(address);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TokenDetails</returns>
        public Imx.Sdk.Gen.Client.ApiResponse<TokenDetails> GetTokenWithHttpInfo(string address, int operationIndex = 0)
        {
            // verify the required parameter 'address' is set
            if (address == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'address' when calling TokensApi->GetToken");
            }
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<TokenDetails> localVarResponse = await GetTokenWithHttpInfoAsync(address, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TokenDetails)</returns>
        public async System.Threading.Tasks.Task<Imx.Sdk.Gen.Client.ApiResponse<TokenDetails>> GetTokenWithHttpInfoAsync(string address, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'address' is set
            if (address == null)
            {
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<ListTokensResponse> localVarResponse = ListTokensWithHttpInfo(pageSize, cursor, orderBy, direction, address, symbols);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ListTokensResponse</returns>
        public Imx.Sdk.Gen.Client.ApiResponse<ListTokensResponse> ListTokensWithHttpInfo(int? pageSize = default(int?), string cursor = default(string), string orderBy = default(string), string direction = default(string), string address = default(string), string symbols = default(string), int operationIndex = 0)
        {
            Imx.Sdk.Gen.Client.RequestOptions localVarRequestOptions = new Imx.Sdk.Gen.Client.RequestOptions();
            ...
            if (address != null)
            {
                localVarRequestOptions.QueryParameters.Add(Imx.Sdk.Gen.Client.ClientUtils.ParameterToMultiMap("", "address", address));
            }
            if (symbols != null)
            {
                localVarRequestOptions.QueryParameters.Add(Imx.Sdk.Gen.Client.ClientUtils.ParameterToMultiMap("", "symbols", symbols));
            }
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<ListTokensResponse> localVarResponse = await ListTokensWithHttpInfoAsync(pageSize, cursor, orderBy, direction, address, symbols, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
