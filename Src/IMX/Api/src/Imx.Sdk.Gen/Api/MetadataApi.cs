...
namespace Imx.Sdk.Gen.Api
{
    ...
    public partial class MetadataApi : IMetadataApi
    {
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<SuccessResponse> localVarResponse = AddMetadataSchemaToCollectionWithHttpInfo(address, iMXSignature, iMXTimestamp, addMetadataSchemaToCollectionRequest);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SuccessResponse</returns>
        public Imx.Sdk.Gen.Client.ApiResponse<SuccessResponse> AddMetadataSchemaToCollectionWithHttpInfo(string address, string iMXSignature, string iMXTimestamp, AddMetadataSchemaToCollectionRequest addMetadataSchemaToCollectionRequest, int operationIndex = 0)
        {
            // verify the required parameter 'address' is set
            if (address == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'address' when calling MetadataApi->AddMetadataSchemaToCollection");
            }

            // verify the required parameter 'iMXSignature' is set
            if (iMXSignature == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'iMXSignature' when calling MetadataApi->AddMetadataSchemaToCollection");
            }

            // verify the required parameter 'iMXTimestamp' is set
            if (iMXTimestamp == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'iMXTimestamp' when calling MetadataApi->AddMetadataSchemaToCollection");
            }

            // verify the required parameter 'addMetadataSchemaToCollectionRequest' is set
            if (addMetadataSchemaToCollectionRequest == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'addMetadataSchemaToCollectionRequest' when calling MetadataApi->AddMetadataSchemaToCollection");
            }
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<SuccessResponse> localVarResponse = await AddMetadataSchemaToCollectionWithHttpInfoAsync(address, iMXSignature, iMXTimestamp, addMetadataSchemaToCollectionRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SuccessResponse)</returns>
        public async System.Threading.Tasks.Task<Imx.Sdk.Gen.Client.ApiResponse<SuccessResponse>> AddMetadataSchemaToCollectionWithHttpInfoAsync(string address, string iMXSignature, string iMXTimestamp, AddMetadataSchemaToCollectionRequest addMetadataSchemaToCollectionRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'address' is set
            if (address == null)
            {
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<SuccessResponse> localVarResponse = UpdateMetadataSchemaByNameWithHttpInfo(address, name, iMXSignature, iMXTimestamp, metadataSchemaRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of SuccessResponse</returns>
        public Imx.Sdk.Gen.Client.ApiResponse<SuccessResponse> UpdateMetadataSchemaByNameWithHttpInfo(string address, string name, string iMXSignature, string iMXTimestamp, MetadataSchemaRequest metadataSchemaRequest, int operationIndex = 0)
        {
            // verify the required parameter 'address' is set
            if (address == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'address' when calling MetadataApi->UpdateMetadataSchemaByName");
            }

            // verify the required parameter 'name' is set
            if (name == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'name' when calling MetadataApi->UpdateMetadataSchemaByName");
            }

            // verify the required parameter 'iMXSignature' is set
            if (iMXSignature == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'iMXSignature' when calling MetadataApi->UpdateMetadataSchemaByName");
            }

            // verify the required parameter 'iMXTimestamp' is set
            if (iMXTimestamp == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'iMXTimestamp' when calling MetadataApi->UpdateMetadataSchemaByName");
            }

            // verify the required parameter 'metadataSchemaRequest' is set
            if (metadataSchemaRequest == null)
            {
                throw new Imx.Sdk.Gen.Client.ApiException(400, "Missing required parameter 'metadataSchemaRequest' when calling MetadataApi->UpdateMetadataSchemaByName");
            }
            ...
            localVarRequestOptions.PathParameters.Add("address", Imx.Sdk.Gen.Client.ClientUtils.ParameterToString(address)); // path parameter
            localVarRequestOptions.PathParameters.Add("name", Imx.Sdk.Gen.Client.ClientUtils.ParameterToString(name)); // path parameter
            localVarRequestOptions.HeaderParameters.Add("IMX-Signature", Imx.Sdk.Gen.Client.ClientUtils.ParameterToString(iMXSignature)); // header parameter
            localVarRequestOptions.HeaderParameters.Add("IMX-Timestamp", Imx.Sdk.Gen.Client.ClientUtils.ParameterToString(iMXTimestamp)); // header parameter
        ...
        {
            Imx.Sdk.Gen.Client.ApiResponse<SuccessResponse> localVarResponse = await UpdateMetadataSchemaByNameWithHttpInfoAsync(address, name, iMXSignature, iMXTimestamp, metadataSchemaRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SuccessResponse)</returns>
        public async System.Threading.Tasks.Task<Imx.Sdk.Gen.Client.ApiResponse<SuccessResponse>> UpdateMetadataSchemaByNameWithHttpInfoAsync(string address, string name, string iMXSignature, string iMXTimestamp, MetadataSchemaRequest metadataSchemaRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'address' is set
            if (address == null)
            {
