...
namespace api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListTransfersResponse")]
    public partial class ListTransfersResponse : IEquatable<ListTransfersResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransfersResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListTransfersResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListTransfersResponse" /> class.
        /// </summary>
        ...
        public ListTransfersResponse(string cursor = default(string), int remaining = default(int), List<Transfer> result = default(List<Transfer>))
        {
            // to ensure "cursor" is required (not null)
            if (cursor == null)
            {
                throw new ArgumentNullException("cursor is a required property for ListTransfersResponse and cannot be null");
            }
            this.Cursor = cursor;
            ...
            if (result == null)
            {
                throw new ArgumentNullException("result is a required property for ListTransfersResponse and cannot be null");
            }
            this.Result = result;
        }
