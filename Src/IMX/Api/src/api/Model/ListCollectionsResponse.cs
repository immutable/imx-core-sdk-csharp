...
namespace api.Model
{
    ...
    public partial class ListCollectionsResponse : IEquatable<ListCollectionsResponse>, IValidatableObject
    {
        ...
        public ListCollectionsResponse(string cursor = default(string), int remaining = default(int), List<Collection> result = default(List<Collection>))
        {
            // to ensure "cursor" is required (not null)
            if (cursor == null)
            {
                throw new ArgumentNullException("cursor is a required property for ListCollectionsResponse and cannot be null");
            }
            this.Cursor = cursor;
            ...
            if (result == null)
            {
                throw new ArgumentNullException("result is a required property for ListCollectionsResponse and cannot be null");
            }
            this.Result = result;
        }
